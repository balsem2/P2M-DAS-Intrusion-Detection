...
\begin{itemize}
    \item \texttt{CNN-Model/Data\_Preparation/extract\_dataset\_2d.py} : extraction des caractéristiques.
    \item \texttt{CNN-Model/Model/train\_from\_extracted\_2d.py} : entraînement du CNN.
    \item \texttt{CNN-Model/Trained\_Model/classes\_das\_2d.npy} : noms des classes.
